...
shinyUI(fluidPage(
        ...
        sidebarLayout(
                ...
                mainPanel(
                        tabsetPanel(
                                ...
                                tabPanel("App",
                                         ...
                                         tabsetPanel(
                                                 tabPanel("vs",
                                                          fluidRow(
                                                                  column(5,uiOutput("ui_cb_obj")),
                                                                  column(5,uiOutput("ui_cb_subj"))
                                                          ),
                                                          plotOutput("plot1",
                    ...
                    select/deselect all."),
                                         h6("Tab 'vs' is intended for exploratory data analysis.
                    The user should classify selected features as 
                    objective or subjective. The plot of subjective
                    features' means versus objective means will appear.
                    User can also click on or highlight multiple
                    points to see the numbers and section label."),
